    ...
    SecurityFilterChain apiSecurityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/*/reopen").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/*/visibility").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/*/tags").authenticated()
