...
export class AuthController {
    ...
    @UseGuards(FacebookGuard)
    facebookCallback(@Req() req: Request, @Res({ passthrough: true }) res: Response) {
        return this.authService.oauthLogin(req, res);
    }
    ...
    @Delete('sessions/:id')
    logoutSession(@Param('id') id: string, @Req() req: Request) {
        return this.authService.logoutSession(id, req);
    }
