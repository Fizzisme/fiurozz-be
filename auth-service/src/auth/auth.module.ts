...
@Module({
    imports: [JwtModule.register({}), AccountModule, OauthAccountModule, OutboxEventModule],
    controllers: [AuthController],
    providers: [AuthService, JwtTokenService, PasswordService, RefreshTokenService, TokenService],
})
